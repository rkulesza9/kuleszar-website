		...
		<section id="welcome-hero" class="welcome-hero">
			<div class="container">
              ...
              <a target="_blank" href="https://docs.google.com/document/d/1X0mQmsEkjs9c4w5-ScHWE-ytSyZ1-I9Irq_xT3kJdLY/edit#heading=h.gjdgxs" >download resume</a><br><br>
							<a href="assets/download/resume.txt" download>download resume TXT</a>
						</div><!--/.header-text-->
					</div><!--/.col-->
				</div><!-- /.row-->
			</div><!-- /.container-->
						...
						<div class="col-sm-4">
							<div class="single-horizontal-timeline">
								<div class="experience-time">
									<h2>Sept 2017 - Current</h2>
									<h3>Bachelor Degree <span>in </span> Comp Sci and Math</h3>
								</div><!--/.experience-time-->
						...
						<div class="col-sm-4">
							<div class="single-horizontal-timeline">
								<div class="experience-time">
									...
									<h3>Associate <span>of </span> Mathematics</h3>
								</div><!--/.experience-time-->
								<div class="timeline-horizontal-border">
									<i class="fa fa-circle" aria-hidden="true"></i>
									<span class="single-timeline-horizontal"></span>
